...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-27 11:39`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b2d76a4e-2d32-4371-af5a-0b7c38fe173c.git
$ cd b2d76a4e-2d32-4371-af5a-0b7c38fe173c
```
